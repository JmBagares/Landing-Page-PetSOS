...
const DotGrid = ({
  ...
  useEffect(() => {
    const onMove = (e) => {
      ...
      // Use standard gsap.to with elastic easing instead of InertiaPlugin
      for (const dot of dotsRef.current) {
        ...
        if (speed > speedTrigger && dist < proximity && !dot._inertiaApplied) {
          ...
          const pushDuration = Math.min(0.4, resistance / 2000);
    ...
    const onClick = (e) => {
      ...
      for (const dot of dotsRef.current) {
        ...
        if (dist < shockRadius && !dot._inertiaApplied) {
          ...
          const pushDuration = Math.min(0.3, resistance / 2500);
